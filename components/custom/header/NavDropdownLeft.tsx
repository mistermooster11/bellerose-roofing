  ...
  return (
    ...
    >
      ...
      <div className="relative pr-[65px]">
        ...
        <Link
          href={dd.titleHref}
          className="group relative inline-block align-top text-[2.1rem] leading-[1.3] font-medium text-[#4CAF51] mb-[1rem] no-underline pr-[50px] group"
        >
        ...
        <div className="pt-[0.5rem] pb-[1rem] text-[#4CAF51] text-[1.2rem] leading-[1.4] border-b border-dashed border-[#a5a5a5]">
          {dd.description}
        </div>
      </div>
        ...
        {dd.links.map((link, li) => (
          ...
          >
            <Link
              ...
              className="group/link relative block text-[#4CAF51] pl-[1.6rem] pr-[1.6rem] no-underline"
            >
              ...
              <span className="relative z-[5] border-b border-[#252525] transition-colors duration-350 group-hover/link:border-brand-orange">
                {link.label}
              </span>
            </Link>
          </li>
