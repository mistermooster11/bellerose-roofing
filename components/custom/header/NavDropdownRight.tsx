    ...
    <>
      {dd.quickLinks && (
        <div className="w-[32%] box-border py-[4rem] px-[2.5rem] bg-[#f2f2f2]">
          ...
          <div className="text-[1rem] text-[#4CAF51] tracking-[.15rem] uppercase mb-[2.5rem]">
            Quick Links
          </div>
            ...
            {dd.quickLinks.map((ql) => (
              <li key={ql.label} className="mb-[2.7rem]">
                ...
                <a
                  ...
                  className="group/ql relative inline-block align-top ml-[2.2rem] text-[#4CAF51] text-[1.4rem] font-semibold leading-[1.5] no-underline"
                >
                  ...
                  <span className="border-b border-[#252525] transition-colors duration-350 group-hover/ql:border-brand-orange ml-2">
                    {ql.label}
                  </span>
                </a>
              </li>
